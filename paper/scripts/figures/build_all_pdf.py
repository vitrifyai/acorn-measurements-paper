...
from assemble_pdf import build_pdf as build
...
rep.append(build("figure2_motion_correction",
    [[P/"fig5/5A_uncorrected.png", P/"fig5/5B_motion_corrected.png"],
     [P/"fig5/5C_trajectory.png",  P/"fig2_motion/2D_dose_dependence.png"]], B/"pdf/main"))
rep.append(build("figure3_cryoTEM_use_case",
    [[P/"fig2/2A.png", P/"fig2/2B.png"],[P/"fig2/2C.png", P/"fig2/2D.png"]], B/"pdf/main"))
rep.append(build("figure4_SEM_use_case",
    [[P/"fig3/3A.png", P/"fig3/3B.png"],[P/"fig3/3C.png", P/"fig3/3D.png"]], B/"pdf/main"))
...
rep.append(build("figureS4_simulated_heldout",
    [[P/"si/S4/S4_transmission_1.png", P/"si/S4/S4_transmission_2.png"],
     ...
     [P/"si/S4/S4_legend.png"]], B/"pdf/si", skip_letters={4},
...
rep.append(build("figureS6_simulation_only_transfer",
    [[P/"si/S6/S6_transmission_simulation_only.png"],
     ...
     [P/"si/S6/S6_legend.png"]], B/"pdf/si", skip_letters={3},
    row_frac=[0.52, 1.0, 0.62]))
rep.append(build("figureS7_reference_composition",
    [[P/"si/S7/S7A_composition.png", P/"si/S7/S7B_recall_precision_by_subset.png"]], B/"pdf/si"))
...
rep.append(build("figureS8_heldout_predictions",
    [[AI4/"figS6/S6_transmission_micrograph.png", AI4/"figS6/S6_transmission_reference.png",
     ...
     [AI4/"figS6/S6_legend.png"]], B/"pdf/si", skip_letters={8},
    row_frac=[1.0, 1.0, 0.62]))
rep.append(build("figureS9_measurement_trace",
    ...
    B/"pdf/si", row_frac=[1.0, 1.0, 0.86]))
# S10 is a single composed figure with its own internal panels
rep.append(build("figureS10_sem_intensity",
    [[P/"si/S10/figureS10_sem_intensity.png"]], B/"pdf/si", letters=False))

(B/"qc/pdf_inventory.json").write_text(json.dumps(rep,indent=1))
for r in rep:
    print(f"  {r['name']:36s} {r['inches'][0]}x{r['inches'][1]} in  "
          f"vector={r['vector_panels']} raster={r['raster_panels']}  "
          f"{r['kb']:>6d} kB  letters={r['letters'] or '(internal)'}")
